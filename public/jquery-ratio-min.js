...
*/
(function(b,e){function c(a,d){this.element=a;this.options=b.extend({},f,d);this.init()}var f={new_height:null,new_width:null,ratio_height:"3",ratio_width:"4",recalculate_on_resize:!1,side:"width"};c.prototype.init=function(){var a=this;b(a.element);a.set();if(a.options.recalculate_on_resize)b(e).on("resize",function(){a.destroy();a.set()})};c.prototype.set=function(){var a=b(this.element);if("height"===this.options.side)var d=this.options.new_height?parseInt(this.options.new_height,10):a.height(),
